...
class PascalVOC2coco(object):
                ...
                for p in fp:
                    ...
                    if 'filename' in p:
                        ...
                        self.path = os.path.join(
                            path, 'SegmentationObject',
                            self.filen_ame.split('.')[0] + '.png')
                    if 'width' in p:
                    ...
                    if flag == 1:
                        ...
                        self.rectangle = [x1, y1, x1 + w, y1 + h]
    ...
    def getsegmentation(self):
        ...
        try:
            ...
            mask[rectangle[1]:rectangle[3],
                 rectangle[0]:rectangle[2]] = mask_1[rectangle[1]:rectangle[3],
    ...
    def mask2polygons(self):
        contours = cv2.findContours(self.mask, cv2.RETR_TREE,
                                    cv2.CHAIN_APPROX_SIMPLE)  # 找到轮廓线
        bbox = []
